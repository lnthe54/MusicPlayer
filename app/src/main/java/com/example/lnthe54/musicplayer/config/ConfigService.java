...
public class ConfigService {
    public static final String ACTION_COMPLETE_SONG = "com.example.lnthe54.musicplayer.ACTION_COMPLETE_SONG";
    public static final String ACTION_SWITCH_SONG = "com.example.lnthe54.musicplayer.ACTION_SWITCH_SONG";
